...
namespace stembowl.Migrations.QuestionDb
{
    ...
    [Migration("20190206015557_FixingTeams2")]
    partial class FixingTeams2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stembowl.Areas.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("stembowl.Models.TeamMembers", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("stembowl.Areas.Identity.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("stembowl.Areas.Identity.ApplicationUser", b =>
                {
                    b.HasOne("stembowl.Models.Team", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("stembowl.Models.Team", b =>
                {
                    b.HasOne("stembowl.Areas.Identity.ApplicationUser", "Leader")
                        .WithMany()
            ...
            modelBuilder.Entity("stembowl.Models.TeamMembers", b =>
                {
                    ...
                    b.HasOne("stembowl.Areas.Identity.ApplicationUser", "TeamMember")
                        .WithMany()
